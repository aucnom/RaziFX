...
public class DateConverter {
     ...
     * {@link Month}
     * @param day positive jalali day, it can be more than 31 and automatically
     ...
     * month from 1 to 12 it's possible to enter 13 in this case it
     * automatically shift to next year, it works for days in a same way.
     * although, for your own comfort it is recommended to use proper values
     *
     * @param year positive jalali year value
     * @param month starts from 1 to 12, but it can be more than 12 as it tires
     * to shift to next year
     * @param day positive jalali day, it can be more than 31 and automatically
     * it tries to shift to next month
     *
    ...
    /**
     * converts gregorian date based on input arguments to jalali date. It's
     * smart enough to calculate target date with every input so instead of
     * month from 1 to 12 it's possible to enter 13 in this case it
     * automatically shift to next year, it works for days in a same way.
     * although, for your own comfort it is recommended to use proper values
     *
     ...
     * @param month starts from 1 to 12, but it can be more than 12 as it tires
     * to shift to next year
     * @param day positive gregorian day, it can be more than 31 and
     * automatically it tries to shift to next month
     *
     * @throws IllegalArgumentException if values are negative.
     * @return JalaliDate object
     * @see JalaliDate
     ...
     * <p>
     * This method works based on {@link LocalDate}, it first gets current date
     * of os-system as gregorian and then casts it to Jalali.
     *
     ...
     * <p>
     * This method created just for convenient, of-course it is possible to
     * directly use LocalDate class.
     *
     ...
     * <p>
     * This method should not be used by other classes or methods outside of
     * this package.
     *
