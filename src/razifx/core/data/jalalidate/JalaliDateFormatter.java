...
public class JalaliDateFormatter {
     ...
     *
     * <p>
     * you can call it from outside of the class for setting formatting
     * language. usually can be used in constructor
     */
     ...
     *
     * @param pattern desired pattern.
     * @param formatLanguage shows the selected language which 1 is persian and
     * 2 is english.
     */
     ...
     * <p>
     * y: year (Note: use yyyy) m: month in number (Note: use mm) M: month in
     * word (Note: use M) d: day (Note: use dd) ' ', '/' and '-' can be used as
     * a separator.
     */
