...
public class JalaliDate {
    ...
    /**
     * Only DateConverter is allowed to create an object of JalaliDate with
     * empty constructor's argument
     * <p>
    ...
    /**
     * reformats jalali date with provided format. the result will be a string
     * in either persian or english.
     *
     * @param jalaliDateFormatter an object that shows preferred format for
     * jalali date.
     ...
     * <p>
     * Note: only classes of this package needs this method, you'll never need
     * it. use constructor instead.
     *
     *
     ...
     * <p>
     * Compares this {@link JalaliDate} with another for ensuring that the date
     * is the same.
     * <p>
